...
export default function BillingPage() {
  const plans = [
    { name: 'Starter', price: '49€', features: ['5 agenți', '100 credite AI/lună', 'Management lead-uri'] },
    { name: 'Pro', price: '99€', features: ['15 agenți', '500 credite AI/lună', 'Pipeline vizual'], recommended: true },
    { name: 'Enterprise', price: 'Custom', features: ['Agenți nelimitați', 'Credite AI nelimitate', 'Suport dedicat'] },
  ];
