  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 py-20 md:py-28">
        <div className="max-w-3xl rounded-[2rem] border border-[#22c55e]/20 bg-black/50 p-8 shadow-[0_30px_90px_-36px_rgba(0,0,0,0.8)] backdrop-blur-xl md:p-12">
          <div className="inline-flex items-center rounded-full border border-[#22c55e]/30 bg-[#22c55e]/10 px-4 py-1.5 text-sm font-medium text-[#86efac]">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <Button asChild size="lg" className="rounded-full bg-[#22c55e] px-7 text-black hover:bg-[#4ade80]">
