                            ...
                            {isLoading ? (
                                ...
                                agents.map(agent => (
                                    <TableRow key={agent.id} className="border-white/20 hover:bg-white/10">
                                        ...
                                        <TableCell className="text-white/90">{agent.email}</TableCell>
                                        <TableCell><Badge variant={agent.role === 'admin' ? 'default' : 'secondary'} className={agent.role === 'admin' ? '' : 'bg-white/20 text-white border-none'}>{agent.role}</Badge></TableCell>
                                    </TableRow>
                                ))
                            ) : (
