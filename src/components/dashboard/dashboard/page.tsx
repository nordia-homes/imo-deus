...
import type { Property, Viewing, Task, Contact, BuyerSourceData, ConversionData } from '@/lib/types';
...
export default function DashboardPage() {
    ...
    const { 
        ...
        const newBuyersCount = contacts?.filter(c => c.createdAt && new Date(c.createdAt) > oneWeekAgo).length || 0;
        ...
        const buyerSourceDataResult: BuyerSourceData[] = Object.keys(sourceCounts).map((source, index) => ({
            source,
        ...
        return {
            ...
            totalSalesCount,
            newBuyersCount,
            buyerSourceData: buyerSourceDataResult,
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                ...
                <StatCard title="Cumpărători Noi" value={`+${newBuyersCount}`} period="în ultima săptămână" icon={<Users />} />
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                ...
                <Card className="col-span-3 shadow-2xl rounded-2xl">
                    ...
                    <CardContent>
                        <LeadSourceChart data={buyerSourceData} />
                    </CardContent>
                </Card>
            </div>
