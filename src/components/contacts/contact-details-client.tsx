...
import { Loader2, Sparkles, Wand2, Phone, Mail, Euro, Info, MapPin } from 'lucide-react';
    ...
    <div className="space-y-6">
        ...
        <Tabs defaultValue="details" className="w-full">
            <TabsList className="grid w-full grid-cols-4">
                <TabsTrigger value="details">Detalii Lead</TabsTrigger>
                <TabsTrigger value="match">Potrivire Proprietăți (AI)</TabsTrigger>
                <TabsTrigger value="score">Scor Lead (AI)</TabsTrigger>
            ...
            <TabsContent value="details">
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
                    <Card className="lg:col-span-1">
                        ...
                        <CardContent className="space-y-4 text-sm">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <span>Sursa: {contact.source || 'N/A'}</span>
                            </div>
                             <div className="flex items-center gap-3">
                                <Euro className="h-4 w-4 text-muted-foreground" />
                                <span>Buget: €{contact.budget?.toLocaleString() || 'N/A'}</span>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="lg:col-span-2">
                        <CardHeader>
                            <CardTitle>Preferințe Locație</CardTitle>
                        </CardHeader>
                         <CardContent>
                            {contact.city ? (
                                <>
                                    ...
                                    {contact.zones && contact.zones.length > 0 ? (
                                        ...
                                        <p className="text-muted-foreground mt-2">Nicio zonă specifică selectată.</p>
                                    )}
                                </>
                            ) : (
                                <p className="text-muted-foreground">Nicio preferință de locație adăugată.</p>
                            )}
                        </CardContent>
                    </Card>
                    ...
                    <Card className="lg:col-span-3">
                        ...
                        <CardContent>
                            <Textarea defaultValue={contact.notes} rows={6} placeholder="Adaugă notițe aici..."/>
                        </CardContent>
                         <CardFooter>
