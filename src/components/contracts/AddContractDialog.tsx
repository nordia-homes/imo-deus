...
import type { Contract, Property, Contact as ContactType } from '@/lib/types';
    ...
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Selectează clientul și proprietatea pentru a crea un nou draft.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 pt-4">
            ...
            <DialogFooter className="pt-4">
              ...
              <Button type="submit">Generează Draft</Button>
            </DialogFooter>
          </form>
        </Form>
      </DialogContent>
