...
export function ActionsColumn({ property, allProperties, viewings, agentProfile }: { property: Property, allProperties: Property[], viewings: Viewing[], agentProfile: UserProfile | null }) {
