...
export function MetaAdsCard({ property }: { property: Property }) {
  ...
  async function handleCreateDraft() {
    ...
    try {
      ...
      upsertCampaign(payload.campaign as MetaMarketingCampaignDraft);
      toast({
          ...
          {latestCampaign ? (
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                <Button type="button" className={`flex-1 rounded-full ${ACTION_PILL_CLASSNAME}`} onClick={() => setEditingCampaign(latestCampaign)}>
