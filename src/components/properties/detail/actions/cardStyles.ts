export const ACTION_CARD_CLASSNAME =
  "overflow-hidden rounded-[1.7rem] border border-white/8 [background:var(--app-surface-elevated)] text-white shadow-[0_24px_64px_-36px_rgba(0,0,0,0.82)] backdrop-blur-xl";
...
export const ACTION_PILL_CLASSNAME =
  "border border-[var(--app-surface-border)] bg-white/[0.045] text-white hover:bg-white/[0.09]";
