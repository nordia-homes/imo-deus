            ...
            <div className="flex items-center gap-2">
              {whatsappHref ? (
                <Button
                  ...
                  size="icon"
                  variant="secondary"
                  className="agentfinder-client-portal-icon-button agentfinder-sidebar-button agentfinder-sidebar-button--icon bg-emerald-500 text-white hover:bg-emerald-400"
                >
